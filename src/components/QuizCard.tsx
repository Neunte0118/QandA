...
export function QuizCard({
  ...
  return (
    <div className="w-full max-w-xl mx-auto flex flex-col gap-2.5 sm:gap-3.5 pb-28 sm:pb-0 select-none">
      ...
      <div className="sm:hidden flex items-center justify-between px-2 text-[11px] text-neutral-400">
      ...
      <div className="relative w-full">
        ...
        {isDragging && (
          <div className="absolute inset-0 rounded-2xl flex items-center justify-between px-6 pointer-events-none z-0">
            {/* Left cue: Correct */}
            <div
              className={`flex items-center gap-2 text-emerald-600 font-bold transition-opacity ${
            ...
            {/* Right cue: Incorrect */}
            <div
              className={`flex items-center gap-2 text-red-600 font-bold transition-opacity ${
        ...
        <div
          ...
          className={`relative z-10 w-full min-h-[300px] sm:min-h-[360px] bg-white border border-neutral-200 rounded-2xl p-5 sm:p-7 flex flex-col justify-between shadow-xs hover:border-neutral-300 cursor-pointer select-none text-left touch-pan-y ${
        ...
        <div className="max-w-md mx-auto flex items-center justify-between pointer-events-auto">
          {showAnswer ? (
            <>
              ...
              <div className="flex flex-col items-center gap-1">
                <button
                  ...
                  className="w-16 h-16 rounded-full bg-emerald-600 active:bg-emerald-700 text-white shadow-lg flex items-center justify-center font-black text-2xl transition-transform active:scale-90 border-2 border-white focus:outline-hidden"
              ...
              <div className="flex flex-col items-center gap-1">
                <button
                  ...
                  className="w-16 h-16 rounded-full bg-red-600 active:bg-red-700 text-white shadow-lg flex items-center justify-center font-black text-2xl transition-transform active:scale-90 border-2 border-white focus:outline-hidden"
            ...
            <button
              ...
              className="w-full text-center py-3 bg-neutral-900 active:bg-neutral-800 text-white rounded-xl shadow-md transition-colors"
            >
